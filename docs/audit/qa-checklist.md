...
- [ ] Phase 3 UX restore: no skeleton/overlay during selection switches
- [ ] Rapid-click 10 matchups: immediate pill updates; no empty/white glow
- [ ] Poll tick does not blank or dim content mid-interaction
