...
function DefensePanel({
  ...
  const teamAData = useMemo(
    () => transformTeamData(defenseData.find(team => team.team === selectedTeamA) || null),
    [transformTeamData, defenseData, selectedTeamA],
  );
  const teamBData = useMemo(
    () => transformTeamData(defenseData.find(team => team.team === selectedTeamB) || null),
    [transformTeamData, defenseData, selectedTeamB],
  );
...
export default memo(DefensePanel);
